...
class Atri:
	def __init__(self, state: Any):
		...
		self.Flexlogolink = state["Flexlogolink"]
		self.Flex7 = state["Flex7"]
		self.herosection = state["herosection"]
		self.herdiv = state["herdiv"]
		self.contntimg = state["contntimg"]
		self.content = state["content"]
		self.Flex10 = state["Flex10"]
		self.favsection = state["favsection"]
	...
	@property
	def Flexlogolink(self):
		self._getter_access_tracker["Flexlogolink"] = {}
		return self._Flexlogolink
	@Flexlogolink.setter
	def Flexlogolink(self, new_state):
		self._setter_access_tracker["Flexlogolink"] = {}
		global default_state
		self._Flexlogolink = Flex(new_state, default_state["Flexlogolink"])
	...
	def herosection(self, new_state):
		...
		global default_state
		self._herosection = Div(new_state, default_state["herosection"])

	@property
	def herdiv(self):
		self._getter_access_tracker["herdiv"] = {}
		return self._herdiv
	@herdiv.setter
	def herdiv(self, new_state):
		self._setter_access_tracker["herdiv"] = {}
		global default_state
		self._herdiv = Div(new_state, default_state["herdiv"])

	@property
	def contntimg(self):
		self._getter_access_tracker["contntimg"] = {}
		return self._contntimg
	@contntimg.setter
	def contntimg(self, new_state):
		self._setter_access_tracker["contntimg"] = {}
		global default_state
		self._contntimg = Flex(new_state, default_state["contntimg"])
	...
	@content.setter
	def content(self, new_state):
		self._setter_access_tracker["content"] = {}
		global default_state
		self._content = Flex(new_state, default_state["content"])
	...
	@property
	def favsection(self):
		self._getter_access_tracker["favsection"] = {}
		return self._favsection
	@favsection.setter
	def favsection(self, new_state):
		self._setter_access_tracker["favsection"] = {}
		global default_state
		self._favsection = Div(new_state, default_state["favsection"])
	...
	@property
	def cd2(self):
		self._getter_access_tracker["cd2"] = {}
		return self._cd2
	@cd2.setter
	def cd2(self, new_state):
		self._setter_access_tracker["cd2"] = {}
		global default_state
		self._cd2 = Flex(new_state, default_state["cd2"])

	@property
	def cd3(self):
		self._getter_access_tracker["cd3"] = {}
		return self._cd3
	@cd3.setter
	def cd3(self, new_state):
		self._setter_access_tracker["cd3"] = {}
		global default_state
		self._cd3 = Flex(new_state, default_state["cd3"])

	@property
	def cd4(self):
		self._getter_access_tracker["cd4"] = {}
		return self._cd4
	@cd4.setter
	def cd4(self, new_state):
		self._setter_access_tracker["cd4"] = {}
		global default_state
		self._cd4 = Flex(new_state, default_state["cd4"])
	...
	def _to_json_fields(self):
		return {
			"Div9": self._Div9,
			"Flexlogolink": self._Flexlogolink,
			"Flex7": self._Flex7,
			"herosection": self._herosection,
			"herdiv": self._herdiv,
			"contntimg": self._contntimg,
			"content": self._content,
			"Flex10": self._Flex10,
			"favsection": self._favsection,
			"Flex11": self._Flex11,
			"Div16": self._Div16,
			"Flex15": self._Flex15,
			"card1": self._card1,
